...
export const MarketNftOfferSell = ({ ...props }: MarketNftMintingProps) => {
  ...
  return (
    <Form onFinish={register} form={form}>
      <Typography.Title>NFT 판매 제안</Typography.Title>
      ...
      <Space size="large">
        <Button loading={loading} htmlType="submit">판매 제안</Button>
